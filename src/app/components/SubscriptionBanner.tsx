...
export default function SubscriptionBanner() {
  ...
  // Prikaži banner samo za trial i grace period
  // Za sve ostale status (premium, aktivna pretplata, itd.) ne prikazuj banner
  // Status pretplate se prikazuje samo u profilu
  return null;
}
